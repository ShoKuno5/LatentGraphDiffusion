...
from torch_geometric.graphgym.config import (cfg, dump_cfg,
                                             set_cfg, load_cfg,
                                             makedirs_rm_exist)
# from torch_geometric.graphgym import get_loader, create_dataset
from torch_geometric.graphgym.loader import create_loader, get_loader, create_dataset
...
def custom_create_loader():
    ...
    eval_batch_size = cfg.train.get('eval_batch_size', None)
