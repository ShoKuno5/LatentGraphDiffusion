"""
Utility helpers for LatentGraphDiffusion.

This module exposes helper functions that used to live in ``lgd/utils.py`` so
that ``from lgd.utils import ...`` works with the package layout.
"""
